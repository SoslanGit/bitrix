...
<div class="site-section">
	...
	Array(
		...
		"DETAIL_URL" => "",
		"FIELD_CODE" => array(0=>"ID",1=>"CODE",2=>"NAME",3=>"PREVIEW_TEXT",4=>"PREVIEW_PICTURE",5=>"DETAIL_TEXT","PROPERTY_TWITTER","PROPERTY_TWITTERLINK","PROPERTY_FACEBOOKLINK","PROPERTY_INSTAGRAMLINK","PROPERTY_INSTAGRAM","PROPERTY_FACEBOOK"),
		"IBLOCKS" => array(0=>"8",),
		"IBLOCK_TYPE" => "agents",
		"NEWS_COUNT" => "20",
		"SORT_BY1" => "SORT",
